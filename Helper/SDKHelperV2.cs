...
{    
    public class SDKHelperV2
    {
        ...
        public int sta_ConnectTCP(List<String> lstOutputInfo, string ip, string port, string commKey)
        {
            if (ip == "" || port == "" || commKey == "")
            {
                lstOutputInfo.Add("*Name, IP, Port or Commkey cannot be null !");
                return -1;// ip or port is null
            }

            if (Convert.ToInt32(port) <= 0 || Convert.ToInt32(port) > 65535)
            {
                lstOutputInfo.Add("*Port illegal!");
                return -1;
            }

            if (Convert.ToInt32(commKey) < 0 || Convert.ToInt32(commKey) > 999999)
            {
                lstOutputInfo.Add("*CommKey illegal!");
                return -1;
            }
            ...
            if (bIsConnected == true)
            {
                ...
                lstOutputInfo.Add("Disconnect with device !");
                //connected = false;
                return -2; //disconnect
            }
            ...
            if (axCZKEM1.Connect_Net(ip, Convert.ToInt32(port)) == true)
            {
                ...
                sta_RegRealTime(lstOutputInfo);
                lstOutputInfo.Add("Connect with device !");
            ...
            else
            {
                ...
                lstOutputInfo.Add("*Unable to connect the device,ErrorCode=" + idwErrorCode.ToString());
                return idwErrorCode;
            }
        }

        public int sta_ConnectRS(List<String> lstOutputInfo, string deviceid, string port, string baudrate, string commkey)
        {
            if (deviceid == "" || port == "" || baudrate == "" || commkey == "")
            {
                lstOutputInfo.Add("*Device ID, Port, Baudrate, Comm Key cannot be null !");
                return -1;
            }

            if (Convert.ToInt32(deviceid) < 0 || Convert.ToInt32(deviceid) > 256)
            {
                lstOutputInfo.Add("*Device illegal!");
                return -1;
            }
        ...
        public int sta_ConnectUSB(List<String> lstOutputInfo, string deviceid, string commkey)
        {
            if (deviceid == "" || commkey == "")
            {
                lstOutputInfo.Add("*deviceid, commkey cannot be null !");
                return -1;
            }
            ...
            {
                lstOutputInfo.Add("*The Device ID is invalid !");
                return -1;
            }
            ...
            if (bSearch == false)
            {
                lstOutputInfo.Add("*Can not find the virtual serial port that can be used !");
                return -1;
            }
        ...
        public int sta_GetDeviceInfo(List<String> lstOutputInfo, out string sFirmver, out string sMac, out string sPlatform, out string sSN, out string sProductTime, out string sDeviceName, out int iFPAlg, out int iFaceAlg, out string sProducter)
        {
            int iRet = 0;
            ...
            {
                lstOutputInfo.Add("*Please connect first!");
                return -1024;
            }
            ...
            */
             ...
             */
            //lstOutputInfo.Add("[func GetDeviceFirmwareVersion]Temporarily unsupported");
            ...
            lstOutputInfo.Add("Get the device info successfully");
            iRet = 1;
            return iRet;
        }

        public int sta_GetCapacityInfo(List<String> lstOutputInfo, out int adminCnt, out int userCount, out int fpCnt, out int recordCnt, out int pwdCnt, out int oplogCnt, out int faceCnt)
        {
            int ret = 0;
            ...
            lstOutputInfo.Add("Get the device capacity successfully");
        ...
        public int sta_RegRealTime(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*RegEvent failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("*No data from terminal returns!");
                }
            }
            return ret;
        }
        ...
        void axCZKEM1_OnEnrollFingerEx(string EnrollNumber, int FingerIndex, int ActionResult, int TemplateLength)
        {
            //if (ActionResult == 0)
            //{
            //    lstOutputInfo.Add("Enroll finger succeed. UserID=" + EnrollNumber.ToString() + "...FingerIndex=" + FingerIndex.ToString());
            //}
            //else
            //{
            //    lstOutputInfo.Add("Enroll finger failed. Result=" + ActionResult.ToString());
            //}
        ...
        {
            //lstOutputInfo.Add("Door opened" + "...EventType=" + EventType.ToString());
        ...
        {
            //lstOutputInfo.Add("Alarm triggered" + "...AlarmType=" + AlarmType.ToString() + "...EnrollNumber=" + EnrollNumber.ToString() + "...Verified=" + Verified.ToString());
        ...
        {
            //lstOutputInfo.Add("Card event" + "...Cardnumber=" + CardNumber.ToString());
        ...
        {
            //lstOutputInfo.Add("Enroll a　new user" + "...UserID=" + EnrollNumber.ToString());
        ...
        {
            //lstOutputInfo.Add("Delete a finger template" + "...UserID=" + EnrollNumber.ToString() + "..FingerIndex=" + FingerIndex.ToString());
        ...
        {
            //lstOutputInfo.Add("Press finger score=" + Score.ToString());
        ...
        void axCZKEM1_OnAttTransactionEx(string EnrollNumber, int IsInValid, int AttState, int VerifyMethod, int Year, int Month, int Day, int Hour, int Minute, int Second, int WorkCode)
        {
            ...
            //lstOutputInfo.Add("Verify OK.UserID=" + EnrollNumber + " isInvalid=" + IsInValid.ToString() + " state=" + AttState.ToString() + " verifystyle=" + VerifyMethod.ToString() + " time=" + time);
        ...
        {
            string time = Year + "-" + Month + "-" + Day + " " + Hour + ":" + Minute + ":" + Second;
            //lstOutputInfo.Add("Verify OK.UserID=" + EnrollNumber.ToString() + " isInvalid=" + IsInValid.ToString() + " state=" + AttState.ToString() + " verifystyle=" + VerifyMethod.ToString() + " time=" + time);
        ...
        void axCZKEM1_OnVerify(int UserID)
        {
            if (UserID != -1)
            {
                //lstOutputInfo.Add("User fingerprint verified... UserID=" + UserID.ToString());
            }
            else
            {
                //lstOutputInfo.Add("Failed to verify... ");
            }
        ...
        {
            //lstOutputInfo.Add("OnFinger event ");
        ...
        void axCZKEM1_OnWriteCard(int iEnrollNumber, int iActionResult, int iLength)
        {
            if (iActionResult == 0)
            {
                //lstOutputInfo.Add("Write Mifare Card OK" + "...EnrollNumber=" + iEnrollNumber.ToString() + "...TmpLength=" + iLength.ToString());
            }
            else
            {
                //lstOutputInfo.Add("...Write Failed");
            }
        }
        ...
        void axCZKEM1_OnEmptyCard(int iActionResult)
        {
            if (iActionResult == 0)
            {
                //lstOutputInfo.Add("Empty Mifare Card OK...");
            }
            else
            {
                //lstOutputInfo.Add("Empty Failed...");
            }
        }
        ...
        {
            //lstOutputInfo.Add("RTEvent OnKeyPress Has been Triggered, Key: " + iKey.ToString());
        }
        ...
        void axCZKEM1_OnEnrollFinger(int EnrollNumber, int FingerIndex, int ActionResult, int TemplateLength)
        {
            if (ActionResult == 0)
            {
                //lstOutputInfo.Add("Enroll finger succeed. UserID=" + EnrollNumber + "...FingerIndex=" + FingerIndex.ToString());
            }
            else
            {
                //lstOutputInfo.Add("Enroll finger failed. Result=" + ActionResult.ToString());
 ...
 #region UserMng
        ...
        public int sta_DeleteEnrollData(List<String> lstOutputInfo, String cbUseID, String cbBackupDE)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("*Please input data first!");
                return -1023;
            }
            ...
            if (axCZKEM1.SSR_DeleteEnrollData(iMachineNumber, sUserID, iBackupNumber))
            {
                ...
                lstOutputInfo.Add("SSR_DeleteEnrollData,UserID=" + sUserID + " BackupNumber=" + iBackupNumber.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                if (idwErrorCode == 0 && iBackupNumber == 11)
                    ...
                    lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
            }
         ...
         */
        public int sta_DelUserTmp(List<String> lstOutputInfo, String UseID, String FingerIndex)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (UseID.Trim() == "" || FingerIndex.Trim() == "")
            {
                lstOutputInfo.Add("*Please input data first! UseID or FingerIndex");
                return -1023;
            }

            int idwErrorCode = 0;
            string sUserID = UseID.Trim();
            int iFingerIndex = Convert.ToInt32(FingerIndex.Trim());

            if (axCZKEM1.SSR_DelUserTmpExt(iMachineNumber, sUserID, iFingerIndex))
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("SSR_DelUserTmpExt,UserID:" + sUserID + " FingerIndex:" + iFingerIndex.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_OnlineEnroll(List<String> lstOutputInfo, TextBox txtUserID, ComboBox cbFingerIndex, ComboBox cbFlag)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("*User ID error! The max length is " + iPIN2Width.ToString());
                return -1022;
            }
            ...
            if (iIsABCPinEnable == 0 || iT9FunOn == 0)
            {
                ...
                {
                    lstOutputInfo.Add("*User ID error! The first letter can not be as 0");
                    return -1022;
                }
                ...
                foreach (char tempchar in txtUserID.Text.ToCharArray())
                {
                    ...
                    {
                        lstOutputInfo.Add("*User ID error! User ID only support digital");
                        return -1022;
                    }
                }
            }
            ...
            {
                lstOutputInfo.Add("Start to Enroll a new User,UserID=" + sUserID + " FingerID=" + iFingerIndex.ToString() + " Flag=" + iFlag.ToString());
                if (axCZKEM1.StartIdentify())
                {
                    lstOutputInfo.Add("Enroll a new User,UserID" + sUserID);
                }
        ...
        public int sta_SetUserInfo(List<String> lstOutputInfo, TextBox txtUserID, TextBox txtName, ComboBox cbPrivilege, TextBox txtCardnumber, TextBox txtPassword)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (iPrivilege == 5)
            {
                lstOutputInfo.Add("*User Defined Role is Error! Please Register again!");
                return -1023;
            }
            ...
            if(iPrivilege == 4)
            {
                ...
                if (bFlag == false)
                {
                    lstOutputInfo.Add("*User Defined Role is unable!");
                    return -1023;
                }
            }
             */
            //lstOutputInfo.Add("[func IsUserDefRoleEnable]Temporarily unsupported");
            ...
            */
            ...
            {
                lstOutputInfo.Add("Set user information successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_GetUserInfo(List<String> lstOutputInfo, TextBox txtUserID, TextBox txtName, ComboBox cbPrivilege, TextBox txtCardnumber, TextBox txtPassword)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("*Please input user id first!");
                return -1023;
            }
            ...
            if (axCZKEM1.SSR_GetUserInfo(iMachineNumber,txtUserID.Text.Trim(), out strName, out strPassword,out iPrivilege, out bEnabled))//upload the user's information(card number included)
            {
                ...
                lstOutputInfo.Add("Get user information successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                lstOutputInfo.Add("The User is not exist");
                //end by Leonard
                lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
            }
            axCZKEM1.EnableDevice(iMachineNumber, true);
        ...
        public int sta_GetHIDEventCardNum(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("GetHIDEventCardNumAsStr! HIDCardNum=" + strHIDEventCardNum);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUserValidDate(List<String> lstOutputInfo, ComboBox cbExpires, TextBox txtID2, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtCount)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("*Please input user ID or Exprires first!");
                return -1023;
            }
            ...
            switch (expires)
            {
                ...
                case 1:
                    ...
                    {
                        lstOutputInfo.Add("*Please input StartDate or EndDate first!");
                        return -1022;
                    }
                ...
                case 2:
                    ...
                    {
                        lstOutputInfo.Add("*The Count is error!");
                        return -1022;
                    }
                ...
                default:
                    lstOutputInfo.Add("*Expires Error,please input again!");
                    return -1022;
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("Successfully set the ValidDate!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
            ...
            //lstOutputInfo.Add("[func SetUserValidDate]Temporarily unsupported");

            return 1;
        }

        public int sta_GetUserValidDate(List<String> lstOutputInfo, ComboBox cbExpires, TextBox txtID2, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtCount)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.GetUserValidDate(iMachineNumber, sUserID, out iExpires, out validcount, out sStartDate, out sEndDate))
            {
                ...
                lstOutputInfo.Add("Get user valid date successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode == -4996)          //User is exsit but not set ValideDate
                {
                    ...
                    txtCount.Text = "0";
                    lstOutputInfo.Add("*Operation failed,This User Don't Set ValideDate Or LimitCounts.");
                }
                else if (idwErrorCode == -4993)     //User is not exist
                {
                    ...
                    dtEndDate.Text = DateTime.Now.ToShortDateString().ToString();
                    txtCount.Text = "0";
                    lstOutputInfo.Add("*Operation failed,This User is not exist.");
                }
                else
                {
                    txtCount.Text = " ";
            ...
            //lstOutputInfo.Add("[func GetUserValidDate]Temporarily unsupported");

            return 1;
        }

        public int sta_GetUserVerifyStyle(List<String> lstOutputInfo,  ComboBox cbUserID7, ComboBox cbVerifyStyle )
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.GetUserInfoEx(GetMachineNumber(), Convert.ToInt32(sUserID), out iVerifyStyle, out bReserved))
            {
                ...
                lstOutputInfo.Add("Get user verify style successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
            ...
            */
            ...
            //lstOutputInfo.Add("[func GetUserVerifyStyle]Temporarily unsupported");
            return 1;
        }

        public int sta_SetUserVerifyStyle(List<String> lstOutputInfo, ComboBox cbUserID7, ComboBox cbVerifyStyle)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("*Please input the UserID or VerifyStyle!");
                return -1023;
            }
            int idwErrorCode = 0;
            ...
            {
                lstOutputInfo.Add("Set verify style successfully!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
            ...
            */
            //lstOutputInfo.Add("[func SetUserVerifyStyle]Temporarily unsupported");
        ...
        public int sta_GetUserRole(List<String> lstOutputInfo, ComboBox cbUserRole, int[] iAppState, int[] iFunUserMng, int[] iFunAccess, int[] iFunICCard, int[] iFunComm, int[] iFunSystem, int[] iFunPersonalize, int[] iFunDataMng, int[] iFunUSBMng, int[] iFunAttSearch, int[] iFunPrint, int[] iFunSMS, int[] iFunWorkCode, int[] iFunAutoTest, int[] iFunSysInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (cbUserRole.Text == "")
            {
                lstOutputInfo.Add("*Please input user role!");
                return -1023;
            }
...
/*
            ...
            if (axCZKEM1.GetAppOfRole(iMachineNumber, iUserRole, out sAppName))
            {
                if (axCZKEM1.GetFunOfRole(iMachineNumber, iUserRole, out sFunName))
                {
                    ...
                    lstOutputInfo.Add("Get user role successfully! ");
                }
                else
                {
                    axCZKEM1.GetLastError(ref idwErrorCode);
                    lstOutputInfo.Add("*Get sub menu failed,ErrorCode=" + idwErrorCode.ToString());
            ...
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                lstOutputInfo.Add("*Get top menu failed,ErrorCode=" + idwErrorCode.ToString());
            }
            */
            lstOutputInfo.Add("[func GetAppOfRole]Temporarily unsupported");
            //axCZKEM1.EnableDevice(iMachineNumber, true);

            return 1;
        }

        public int sta_SetUserRole(List<String> lstOutputInfo, ComboBox cbUserRole, int[] iAppState, int[] iFunUserMng, int[] iFunAccess, int[] iFunICCard, int[] iFunComm, int[] iFunSystem, int[] iFunPersonalize, int[] iFunDataMng, int[] iFunUSBMng, int[] iFunAttSearch, int[] iFunPrint, int[] iFunSMS, int[] iFunWorkCode, int[] iFunAutoTest, int[] iFunSysInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
...
*/
            ...
            for (int i = 0; i < iFunUserMng.Length; i++)
            {
                if (iFunUserMng[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set User Mgt menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunAccess.Length; i++)
            {
                if (iFunAccess[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Access Control menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunICCard.Length; i++)
            {
                if (iFunICCard[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set IC Card menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunComm.Length; i++)
            {
                if (iFunComm[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Comm menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunSystem.Length; i++)
            {
                if (iFunSystem[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set System menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunPersonalize.Length; i++)
            {
                if (iFunPersonalize[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Personalize menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunDataMng.Length; i++)
            {
                if (iFunDataMng[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Data Mgt menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunUSBMng.Length; i++)
            {
                if (iFunUSBMng[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set USB Manager menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set USB Manager menu failed,menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
            }
            ...
            for (int i = 0; i < iFunAttSearch.Length; i++)
            {
                if (iFunAttSearch[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Attendance menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunPrint.Length; i++)
            {
                if (iFunPrint[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Print menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunSMS.Length; i++)
            {
                if (iFunSMS[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Short Message menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd ++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunWorkCode.Length; i++)
            {
                if (iFunWorkCode[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Work Code menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunAutoTest.Length; i++)
            {
                if (iFunAutoTest[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set Auto Test menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            for (int i = 0; i < iFunSysInfo.Length; i++)
            {
                if (iFunSysInfo[i] == 1)
                {
                    ...
                    {
                        axCZKEM1.GetLastError(ref idwErrorCode);
                        lstOutputInfo.Add("*Set System Info menu failed,sub menu index=" + i.ToString() + ",ErrorCode=" + idwErrorCode.ToString());
                        dd++;
                    }
                }
                else
            ...
            if (dd == 0)
            {
                lstOutputInfo.Add("Set User Role successfully~");
            }
            */
            lstOutputInfo.Add("[func SetPermOfAppFun]Temporarily unsupported");
            return 1;
        }
        #endregion
        #region UserBio
        ...
        */
        ...
        public void sta_getEmployees2CSV(String fileName)
        {
            if (!GetConnectState())
            {
                return ;
        ...
        public int sta_GetAllBellData(List<String> lstOutputInfo, DataTable dt_allBell)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.ReadAllBellSchData(GetMachineNumber()))//read all the bell schedual data records to the memory
            {
                ...
                ret = 1;
                lstOutputInfo.Add("Get bell successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Read all bell schedual data failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_setBellInfo(List<String> lstOutputInfo, int weekday, int index, int Enable, int Hour, int min, int voice, int bellway, int inerbelldelay, int extbelldelay)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.GetBellSchDataEx(GetMachineNumber(), tmpWeekday, index, out tmpEnable, out tmpHour, out tmpMin, out tmpVoice, out tmpBellway, out tmpInerbelldelay, out tmpExtbelldelay) == false)
            {
                ...
                if (iCurBellCount >= 64)
                {
                    lstOutputInfo.Add("*The bell count is 64!!!");
                    return -1023;
                }
            }
            ...
            {
                lstOutputInfo.Add("*The Device does not support external bell!");
                return -1022;
            }
            ...
            if (axCZKEM1.SetBellSchDataEx(GetMachineNumber(), weekday, index, Enable, Hour, min, voice, bellway, inerbelldelay, extbelldelay))
            {
                ...
                ret = 1;
                lstOutputInfo.Add("Set Bell Schedule successfully!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Set bell info failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_getAllShortkeyFunctionName(List<String> lstOutputInfo, ComboBox cb_stKey, ComboBox cb_function)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Read all ShortkeyName FunctionName data failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_getShortkeyByID(List<String> lstOutputInfo, int ShortKeyID, ref string ShortKeyName, ref string FunctionName, ref int ShortKeyFun, ref int stateCode, ref string stateName, ref string description, ref int intAutoChange, ref string strAutoChangeTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("Get shortkey successfully. Name:" + ShortKeyName + ",FunctionName:" + FunctionName);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*GetShortkeyByID failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    ret = -1;
        ...
        public int sta_setShortkey(List<String> lstOutputInfo, int ShortKeyID, string ShortKeyName, string FunctionName, int ShortKeyFun, int stateCode, string stateName, string description,  int intAutoChange, string strAutoChangeTime)
        {
            ...
            {
                lstOutputInfo.Add("Set shortkey successfully. Name:" + ShortKeyName + ",FunctionName:" + FunctionName);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*SetShortkey failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_uploadAdvertisePicture(List<String> lstOutputInfo, string pictureFile,string pictureName)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                ret = 1;
                lstOutputInfo.Add("Update a advertise picture!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Upload advertise picture failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_uploadWallpaper(List<String> lstOutputInfo, string pictureFile, string pictureName)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                ret = 1;
                lstOutputInfo.Add("Update a wallpaper!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Upload wallpaper failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_readAttLog(List<String> lstOutputInfo, DataTable dt_log)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Read attlog failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_readAttLog2CSV(List<String> lstOutputInfo, String fileName, String yearmonth)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            using (StreamWriter streamwriter = File.CreateText(fileName))
            {
                ...
                if (axCZKEM1.ReadGeneralLogData(GetMachineNumber()))
                {
                                ...
                                out idwInOutMode, out idwYear, out idwMonth, out idwDay, out idwHour, out idwMinute, out idwSecond, ref idwWorkcode))//get records from the memory
                    {
                        ...
                        //dr["WorkCode"] = idwWorkcode;
                        //dt_log.Rows.Add(dr);
                        if (year == 0 || (year == idwYear && month == idwMonth))
                        {
                            streamwriter.WriteLine(String.Format("{0},{1},{2},{3},{4}",
                                sdwEnrollNumber,
                                String.Format("{0}-{1:00}-{2:00} {3:00}:{4:00}:{5:00}", idwYear, idwMonth, idwDay, idwHour, idwMinute, idwSecond)
                                , idwVerifyMode,
                                idwInOutMode,
                                idwWorkcode
                                ));
        ...
        public int sta_readLogByPeriod(List<String> lstOutputInfo, DataTable dt_logPeriod, string fromTime, string toTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.ReadTimeGLogData(GetMachineNumber(), fromTime, toTime))
            {
                            ...
                            out idwInOutMode, out idwYear, out idwMonth, out idwDay, out idwHour, out idwMinute, out idwSecond, ref idwWorkcode))//get records from the memory
                {
                    ...
                    dr["User ID"] = sdwEnrollNumber;
                    dr["Verify Date"] = String.Format("{0}-{1:00}-{2:00} {3:00}:{4:00}:{5:00}", idwYear, idwMonth, idwDay,
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Read attlog by period failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
            ...
            //lstOutputInfo.Add("[func ReadTimeGLogData]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device

            return ret;
        }

        public int sta_DeleteAttLog(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Delete attlog, ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_DeleteAttLogByPeriod(List<String> lstOutputInfo, string fromTime, string toTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Delete attlog by period failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
            ...
            //lstOutputInfo.Add("[func DeleteAttlogBetweenTheDate]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device

            return ret;
        }

        public int sta_DelOldAttLogFromTime(List<String> lstOutputInfo, string fromTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("Please connect first!");
            ...
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Delete old attlog from time failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
            ...
            //lstOutputInfo.Add("[func DeleteAttlogByTime]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device

            return ret;
        }

        public int sta_ReadNewAttLog(List<String> lstOutputInfo, DataTable dt_logNew)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("Please connect first!");
            ...
            //lstOutputInfo.Add("[func ReadNewGLogData]Temporarily unsupported");
            axCZKEM1.EnableDevice(GetMachineNumber(), true);//enable the device
        ...
        #region  AttPhotoMng
        public int sta_GetAllAttPhoto(List<String> lstOutputInfo, string photoPath)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (!axCZKEM1.GetPhotoNamesByTime(GetMachineNumber(), 0, "", "", out AllPhotoName))
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Get photo name failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
            ...
            else
            {
                ...
                for (j = 0; j < len; j++)
                {
                    ...
                    else if (photoname != "")
                    {
                        ...
                        else
                        {
                            ...
                            if (idwErrorCode != 0)
                            {
                                lstOutputInfo.Add("*Get photo failed,ErrorCode: " + idwErrorCode.ToString());
                            }
                            else
                            {
                                lstOutputInfo.Add("No data from terminal returns!");
                ...
                lstOutputInfo.Add("Get All ATT photo succeed.");
                ret = 1;
            }
        ...
        public int sta_GetAllAttPhotoByTimePeriod(List<String> lstOutputInfo, string photoPath, string fromTime, string toTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            lstOutputInfo.Add(fromTime+"-----"+toTime);
            string AllPhotoName = "";
            ...
            else
            {
                ...
                lstOutputInfo.Add("GetAllAttPhotoByTimePeriod succeed.");
                ret = 1;
            }
        ...
        public int sta_GetAllPassPhoto(List<String> lstOutputInfo, string photoPath)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                lstOutputInfo.Add("Get All PASS photo succeed.");
                ret = 1;
            }
        ...
        public int sta_GetPassPhotoByTimePeriod(List<String> lstOutputInfo, string photoPath, string fromTime, string toTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                lstOutputInfo.Add("GetPassPhotoByTimePeriod succeed.");
                ret = 1;
            }
        ...
        public int sta_GetAllBadPhoto(List<String> lstOutputInfo, string photoPath)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                lstOutputInfo.Add("Get All BAD photo succeed.");
                ret = 1;
            }
        ...
        public int sta_GetBadPhotoByTimePeriod(List<String> lstOutputInfo, string photoPath, string fromTime, string toTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            else
            {
                ...
                lstOutputInfo.Add("GetBadPhotoByTimePeriod succeed.");
                ret = 1;
            }
        ...
        public int sta_ClearAllAttPhoto(List<String> lstOutputInfo, int iFlag, string fromTime, string toTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("Clear capture picture OK");
            }
            else
            {
                int errorcode = -1;
                axCZKEM1.GetLastError(ref errorcode);
                lstOutputInfo.Add("Clear capture picture Failed" + errorcode.ToString());
            }
        ...
        #region OPLOG
        public int sta_GetOplog(List<String> lstOutputInfo, DataTable dt_Oplog)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.ReadAllSLogData(GetMachineNumber()))
            {
                ...
                lstOutputInfo.Add("Down oplog success.");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*Get OPLOG failed,ErrorCode: " + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_ClearOplog(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.ClearSLog(GetMachineNumber()))
            {
                ...
                lstOutputInfo.Add("All operation logs have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("ClearOplog failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        #region ClearData
        public int sta_ClearAdmin(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                lstOutputInfo.Add("All administrator have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*ClearAdmin failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_ClearAllLogs(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                lstOutputInfo.Add("All AttLogs have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*ClearAllLogs failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_ClearAllFps(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                lstOutputInfo.Add("All fp templates have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*ClearAllFps failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_ClearAllUsers(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                lstOutputInfo.Add("All users have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*ClearAllUsers failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        public int sta_ClearAllData(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(GetMachineNumber());//the data in the device should be refreshed
                lstOutputInfo.Add("All Data have been cleared from teiminal!");
                ret = 1;
            }
            else
            {
                ...
                if (idwErrorCode != 0)
                {
                    lstOutputInfo.Add("*ClearAllData failed,ErrorCode=" + idwErrorCode.ToString());
                }
                else
                {
                    lstOutputInfo.Add("No data from terminal returns!");
        ...
        #region TimeZone
        public int sta_GetTZInfo(List<String> lstOutputInfo, TextBox txtTZIndex, DateTimePicker dtSUNs, DateTimePicker dtMONs, DateTimePicker dtTUEs, DateTimePicker dtWENs, DateTimePicker dtTHUs, DateTimePicker dtFRIs, DateTimePicker dtSATs, DateTimePicker dtSUNe, DateTimePicker dtMONe, DateTimePicker dtTUEe, DateTimePicker dtWENe, DateTimePicker dtTHUe, DateTimePicker dtFRIe, DateTimePicker dtSATe)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
                return -1024;
            }

            if (txtTZIndex.Text.Trim() == "")
            {
                lstOutputInfo.Add("*Please input TimeZoneIndex first!");
                return -1023;
            }
            ...
            {
                lstOutputInfo.Add("*Timezone index error!");
                return -1022;
            }
            ...
            if (axCZKEM1.GetTZInfo(iMachineNumber, iTimeZoneID, ref sTimeZone))
            {
                ...
                lstOutputInfo.Add("Get TZ info successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                {
                    lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString() + ",Over TimeZoneIndex limits!");
                }
                else
                {
                    lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
        ...
        public int sta_SetTZInfo(List<String> lstOutputInfo, TextBox txtTZIndex, DateTimePicker dtSUNs, DateTimePicker dtMONs, DateTimePicker dtTUEs, DateTimePicker dtWENs, DateTimePicker dtTHUs, DateTimePicker dtFRIs, DateTimePicker dtSATs, DateTimePicker dtSUNe, DateTimePicker dtMONe, DateTimePicker dtTUEe, DateTimePicker dtWENe, DateTimePicker dtTHUe, DateTimePicker dtFRIe, DateTimePicker dtSATe)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            if (axCZKEM1.SetTZInfo(iMachineNumber, iTimeZoneID, sTimeZone))
            {
                ...
                axCZKEM1.RefreshData(iMachineNumber);
                lstOutputInfo.Add("Successfully set the TimeZone" + iTimeZoneID + "！");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                ...
                {
                    lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString() + ",TimeZone Format Error!");
                }
                else
                {
                    lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
        ...
        public int sta_GetGroupTZ(List<String> lstOutputInfo, TextBox txtACGroupNo, TextBox txtTZIndex1, TextBox txtTZIndex2, TextBox txtTZIndex3, ComboBox cboACValidHoliday, ComboBox cbVerifyStyle)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            {
                lstOutputInfo.Add("*Group ID error!");
                return -1022;
            }
            ...
            if (axCZKEM1.SSR_GetGroupTZ(iMachineNumber, iGroupNo, ref iTZ1, ref iTZ2, ref iTZ3, ref iValidHoliday, ref iVerifyStyle))
            {
                ...
                lstOutputInfo.Add("Get group TZ successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetGroupTZ(List<String> lstOutputInfo, TextBox txtACGroupNo, TextBox txtTZIndex1, TextBox txtTZIndex2, TextBox txtTZIndex3, ComboBox cboACValidHoliday, ComboBox cbVerifyStyle)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("Set GroupTZ, GroupNo:" + iGroupNo.ToString() + " VerifyStyle:" + iVerifyStyle.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        #region UnlockGroup
        public int sta_GetUnLockGroup(List<String> lstOutputInfo, ComboBox cboACComNo, ComboBox cboGroup1, ComboBox cboGroup2, ComboBox cboGroup3, ComboBox cboGroup4, ComboBox cboGroup5)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            {
                lstOutputInfo.Add("*Please input params first!");
                return -1023;
            }
            int idwErrorCode = 0;
            ...
            if (axCZKEM1.SSR_GetUnLockGroup(iMachineNumber, iComNo, ref iGroup1, ref iGroup2, ref iGroup3, ref iGroup4, ref iGroup5))
            {
                ...
                lstOutputInfo.Add("Get unlock group successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUnLockGroup(List<String> lstOutputInfo, ComboBox cboACComNo, ComboBox cboGroup1, ComboBox cboGroup2, ComboBox cboGroup3, ComboBox cboGroup4, ComboBox cboGroup5)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            {
                lstOutputInfo.Add("*Please input the five groups first!");
                return -1023;
            }
            int idwErrorCode = 0;
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("SetUnlockGroups, Groups:" + iGroup1.ToString() + ":" + iGroup2.ToString() + ":" + iGroup3.ToString() + ":" + iGroup4.ToString() + ":" + iGroup5.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
                if (idwErrorCode == -2001)
                    lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString()+". Group Not Exist");
                else
                    lstOutputInfo.Add("*Operation failed,ErrorCode=" + idwErrorCode.ToString());
                return idwErrorCode;
            }
        ...
        #region UserGroup
        public int sta_GetUserGroup(List<String> lstOutputInfo, ComboBox cboUAUserIDGroup, TextBox txtGroupNo1)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            if (axCZKEM1.GetUserGroup(iMachineNumber, iUserID, ref iUserGrp))
            {
                ...
                lstOutputInfo.Add("Get user group successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUserGroup(List<String> lstOutputInfo, ComboBox cboUAUserIDGroup, TextBox txtGroupNo1)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("Set User Group, UserID:" + iUserID.ToString() + ", Group No:" + iUserGrp.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        #region UserTimeZone
        public int sta_GetUserTZStr(List<String> lstOutputInfo, ComboBox cboUAUserIDTZ, ComboBox cbUserTZtype, TextBox txtUTZIndex1, TextBox txtUTZIndex2, TextBox txtUTZIndex3)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            */
            ...
            if (axCZKEM1.GetUserTZStr(iMachineNumber, iUserID, ref sTZs))//TZs is in the form of string.
            {
                ...
                lstOutputInfo.Add("Get user TZ successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetUserTZStr(List<String> lstOutputInfo, ComboBox cboUAUserIDTZ, ComboBox cbUserTZtype, TextBox txtUTZIndex1, TextBox txtUTZIndex2, TextBox txtUTZIndex3)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            else
            {
                ...
                {
                    lstOutputInfo.Add("*Please input TZ first!");
                    return -1023;
                }
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("Set user TZ successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_UseGroupTimeZone(List<String> lstOutputInfo, ComboBox cboUAUserIDTZ, Label lbUserTimezoneType)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            if (cboUAUserIDTZ.Text.Trim() == "")
            {
                lstOutputInfo.Add("*Please input the UserID first!");
                return -1023;
            }
            int idwErrorCode = 0;
            ...
            if (axCZKEM1.GetUserTZStr(iMachineNumber, iUserID, ref sTZs))
            {
                if (axCZKEM1.UseGroupTimeZone())
                {
                    ...
                    lstOutputInfo.Add("Using Group TimeZone");
                }
                else
                {
                    lbUserTimezoneType.Text = "Not Using Group TimeZone";
                    lstOutputInfo.Add("Not Using Group TimeZone");
                }
            }
            else
            {
        ...
        public int sta_ACUnlock(List<String> lstOutputInfo, TextBox txtDelay)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            if (axCZKEM1.ACUnlock(iMachineNumber, iDelay))
            {
                ...
                lstOutputInfo.Add("ACUnlock, Dalay Seconds:" + iDelay.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_CloseAlarm(List<String> lstOutputInfo)
        {
            /*
            if (GetConnectState() == false)
            {
            ...
            {
                lstOutputInfo.Add("Close alarm successful");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
             ...
             * */
            lstOutputInfo.Add("[func CloseAlarm]Temporarily unsupported");
            return 1;
        }
        #endregion

        #region get and set wiegandfmt
        public int sta_GetWiegandFmt(List<String> lstOutputInfo, TextBox txtShowWiegandFmt)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            if (axCZKEM1.GetWiegandFmt(iMachineNumber, ref sWiegandFmt))
            {
                ...
                lstOutputInfo.Add("Operation Successed！");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetWiegandFmt(List<String> lstOutputInfo, TextBox txtSetWiegandFmt)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
        ...
        #region Holiday
        public int sta_SetHoliday(List<String> lstOutputInfo, TextBox txtHolidayId, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtTimeZoneId)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            {
                lstOutputInfo.Add("*Holiday ID error");
                return -1022;
            }
        ...
        public int sta_GetHoliday(List<String> lstOutputInfo, TextBox txtHolidayId, DateTimePicker dtStartDate, DateTimePicker dtEndDate, TextBox txtTimeZoneId)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            if (axCZKEM1.SSR_GetHoliday(iMachineNumber, iHolidayId, ref iSMonth, ref iSDay, ref iEMonth, ref iEDay, ref iTimeZoneId))
            {
                ...
                lstOutputInfo.Add("Get holiday successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetNONCTimeZone(List<String> lstOutputInfo, int parName, TextBox parm)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            {
                lstOutputInfo.Add("*The timezone index error!");
                return -1022;
            }
            ...
            if (Convert.ToInt32(par) != 0)
            {
                ...
                {
                    lstOutputInfo.Add("*The NO and NC can not be same!");
                    return -1021;
                }
            }
            if (parName == 81)
        ...
        public int sta_GetNONCTimeZone(List<String> lstOutputInfo, int parName, TextBox parm)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect the device first!");
            ...
            if (axCZKEM1.GetDeviceInfo(iMachineNumber, parName, ref par))
            {
                ...
                lstOutputInfo.Add("Get NO/NC TZ successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SYNCTime(List<String> lstOutputInfo, Label lbDeviceTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("Successfully SYNC the PC's time to device!");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_GetDeviceTime(List<String> lstOutputInfo, Label lbDeviceTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            if (axCZKEM1.GetDeviceTime(iMachineNumber, ref idwYear, ref idwMonth, ref idwDay, ref idwHour, ref idwMinute, ref idwSecond))//show the time
            {
                ...
                lstOutputInfo.Add("Get devie time successfully");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_SetDeviceTime(List<String> lstOutputInfo, DateTimePicker dtDeviceTime)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("Successfully set the time");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_btnPlayWavByIndex(List<String> lstOutputInfo, ComboBox cbWavIndex)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("Position(Wav Index) cannot be null!");
                return -1023;
            }
            ...
            {
                lstOutputInfo.Add("PlayWavByIndex " + iIndex.ToString());
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_btnRestartDevice(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                sta_DisConnect();
                lstOutputInfo.Add("The device will restart");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_btnPowerOffDevice(List<String> lstOutputInfo)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                sta_DisConnect();
                lstOutputInfo.Add("Power off device");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        #region update
        public int sta_btnUpdateFirmware(List<String> lstOutputInfo, TextBox txtFirmwareFile)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("UpdateFirmware,Name=" + sFirmwareFile);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_btnSendFile(List<String> lstOutputInfo, TextBox txtSendFileName)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("*Please input the FileName  first!");
                return -1023;
            }
            ...
            {
                axCZKEM1.RefreshData(iMachineNumber);//the data in the device should be refreshed
                lstOutputInfo.Add("SendFile " + sFileName + " To the Device! ");
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_btnReadFile(List<String> lstOutputInfo, TextBox txtReadFileName, TextBox txtFilePath)
        {
            if (GetConnectState() == false)
            {
                lstOutputInfo.Add("*Please connect first!");
            ...
            {
                lstOutputInfo.Add("*Please input the FileName and FilePath first!");
                return -1023;
            }
            ...
            {
                lstOutputInfo.Add("ReadFile " + sFileName + " To " + sFilePath);
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
